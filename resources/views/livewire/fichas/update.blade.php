    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Update Ficha</h5>
                ...
                <form>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select wire:model.lazy="selectedDepartamento" type="text" class="form-control" name="departamento">
                                <option value="">---</option>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="silla_para">Ayuda técnica para</label>
